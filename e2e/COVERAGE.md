...
| `LODY-SHORTCUT-001`   | Preserve default and user-rebound desktop shortcuts across renderer reload | Command host, settings recorder, sidebar, and renderer reload | Real Electron window and renderer lifecycle | Real owned runtime for local workspace entry | User shortcut override in isolated localStorage | None          |
