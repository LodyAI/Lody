...
（透明度保留、颜色不保留），深色卡上再反相让投影变亮，放大后由卡片边缘裁切。范围和
处理同样重要：它的职责是主数字旁边那块空白，所以锚在右上角，并在标题格那条分隔线之上
收住——第一次尝试让它贯穿整张卡的高度，结果热力图和图例背后都压上了一层投影，而这两块
本来就很密、并不需要。它定位在卡片根节点上、所有信息带都压在它之上，因此只是氛围，
永远不会挤走任何一个数字。
