...
// Generated at: 2026-09-15T10:44:52.990Z
...
export const ACP_REGISTRY_GENERATED_AT = '2026-09-15T10:44:52.990Z';
...
const REMOTE_REGISTRY_ACP_AGENTS: RegistryAcpAgent[] = [
  ...
  },
  {
    ...
    name: 'ZCode ACP',
    version: '0.38.1',
    description: 'Community ACP bridge that drives the real ZCode app-server — native ZCode tools, modes, MCP and sessions, with credentials read from the installed ZCode app.',
    distribution: {
      npx: {
        package: 'acp-extension-zcode@0.38.1'
      }
    }
  }
];
