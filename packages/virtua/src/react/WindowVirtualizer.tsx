...
>(
  (
    ...
    const [store, layout, driver, isHorizontal] = useStatic(() => {
      ...
      return [_store, _layout, createWindowDriver(_store, _isHorizontal), _isHorizontal];
    });
...
) as <T>(props: WindowVirtualizerProps<T> & { ref?: Ref<WindowVirtualizerHandle> }) => ReactElement;
