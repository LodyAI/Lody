...
| [Composer file search](mention-file-search.mjs)     | Ranking latency and renderer responsiveness | `node benchmarks/mention-file-search.mjs 3`              |
...
```sh
BENCH_BROWSER_CHANNEL=chrome node benchmarks/mention-file-search.mjs 3 > /tmp/file-search.json
...
[frozen baseline](fixtures/mention-file-search-baseline.ts) identifies its source
...
[Recorded production run](results/mention-file-search-2026-09-20.json) and
