...
export const COMPOSER_SESSION_SURFACE_CLASS =
  '@container/composer-box flex flex-col gap-1 rounded-xl border-[0.5px] px-2 py-1.5 transition-colors duration-150 border-foreground/[0.10] bg-background dark:border-input-border/70 dark:bg-input/90';
