...
Updated organize mode is a mixed recency list. A nested filter checkbox
("Show project") puts folder / GitHub owner mark + project name under top-level
row titles. Nested opened Sessions stay one title line so the 30px tree trunk
still meets. Workspace-mode Pinned omits the line. Decision:
