...
- Root archive/restore traverses only its `parentSessionId` child Tabs. An independently
  opened Session keeps its own archive state when its opener is archived or restored.
