...
| `use-session-context-compaction-reconciliation.ts`              | One stale-compaction repair attempt per inactive candidate, daemon generation, and ready-connectivity evidence                                      |
