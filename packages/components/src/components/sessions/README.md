...
| `use-session-context-compaction-reconciliation.ts`              | Bounded stale-compaction repair attempts across daemon, browser connectivity, and Session activity transitions                                      |
